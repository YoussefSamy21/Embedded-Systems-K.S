...
static uint8_t TaskA_flag , TaskB_flag , IRQ_Flag = 0;
	...
	while(1)
	{
		...
		if(TaskA_flag == 1)
		{
			/*
				...
				(we will enhance that Later using an Systick timer ... this Lab is Only Proof of Concept)
...
{
	// Our Task Scheduling between Tasks A & B will be based on the EXTI event
	// we will enhance this Later using an Systick timer... this Lab is Only for a Proof of Concept
